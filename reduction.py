...
class Reduction(Scene):
    def construct(self):
        ...
        s = Circle(0.5, GRAY_C, fill_opacity=1)
        ...
        self.add(e, e_text)
        constants.bulk_play(self, [e_group.animate(run_time=constants.SHORT_ANIMATION_TIME).shift(UP + LEFT), 
                                    e_group2.animate(run_time=constants.SHORT_ANIMATION_TIME).shift(UP + RIGHT),
        ...
        all_group = Group(s_group, e_group, e_group2, red_rxn)
